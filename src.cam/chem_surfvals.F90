...
!-----------------------------------------------------------------------------------
   ...
   use exoplanet_mod,  only: exo_porb,exo_n2vmr, exo_co2vmr, exo_ch4vmr, do_exo_atmconst
...
!-----------------------------------------------------------------------
   ...
   call flbc_inti( flbc_file, flbc_list, flbc_timing, exo_co2vmr, exo_ch4vmr, n2ovmr, f11vmr, f12vmr )
...
!
   doymodel = yrmodel*exo_porb    + calday
   doydatam = yrdata(nyrm)*exo_porb + 1._r8
   doydatap = yrdata(nyrp)*exo_porb + 1._r8
