...
!------------------------------------------------------------------------------
! NOTES :: 
! 05-17-2024 XJ added "do_exo_higheccen" and "do_exo_MFA" adapted from Adams et al 2019
!            Applied to config of cam_aqua_fv
  ...
  logical, public, parameter :: do_exo_higheccen = .true.    !! Use the numerical scheme to solve Kepler's equation for non-negligible eccentricity in shr_orb_mod.
  ...
  real(r8), public, parameter :: exo_porb = 360_r8                        !! orbital period, for ob    liquity cycle, and optionally for exo_sday
  ...
  !! ============== STELLAR OPTIONS ============== !!
  !! SOLAR CONSTANT
  !! If do_exo_MFA is true, then exo_scon is orbital-mean insolation.
  logical, public, parameter :: do_exo_MFA = .true.
  ...
  character(len=256), public, parameter :: exo_solar_file ='/home/xuanji//ExoRT/data/solar/G2V_SUN_n68.nc'
  ...
  real(r8), public, parameter :: exo_co2bar  = 4.0e-4_r8                       ! CO2 inventory (bar)
