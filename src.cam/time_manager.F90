! 05-17-24 XJ: delete lines for high-eccentricity calculation
module time_manager
   ...
   use exoplanet_mod, only: exo_ndays,exo_porb
   implicit none
   private
...
! Public methods
   ...
   public ::&
      ...
      get_curr_calday_rotation, &! return calendar day at end of current timestep, with scaling to alter day length
...
! bundy, July 2008
!
!ada: commented the error report.
...
! bundy, July 2008
!
!XJ: delete these lines for high-eccentricity calculation
!
...
subroutine get_curr_calday_rotation(frac_day, day_in_year, offset)
  ...
  ! XJ: modified for different orbital period
  ...
  integer ::&
   ...
   day_earth = day_earth + exo_porb*(yr) + leap_days - 1
