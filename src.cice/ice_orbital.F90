...
! 2024: XJ: 23 Jun Modified to change the orbital period
! !INTERFACE:
!
      module ice_orbital
!
...
! Solar declination for next time step
      ...
      !Wolf  
      !XJ change 365 to exo_porb
      ydayp1 = ydayp1 + exo_porb*(nyr-1)
      ydayp1=ydayp1-1
      frac_day = ydayp1/exo_ndays - FLOOR(ydayp1 / exo_ndays)
      ! day_in_year = yday - exo_porb*FLOOR(yday/exo_porb)  ! scaling for different length years not operable
