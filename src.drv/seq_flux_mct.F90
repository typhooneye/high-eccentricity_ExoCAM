...
!===============================================================================
  ...
  subroutine seq_flux_ocnalb_mct( cdata_o, xao_o, fractions_o, year)
    ...
    !
    ! read ocean surface albedo from exoplanet_mod.F90 (E.T. Wolf)
    ...
    if (flux_albav) then
       ...
       if (nextsw_cday >= -0.5_r8) then
          ...
          !! XJ, Adjust for different orbital period 
          calday = calday + exo_porb*year
